        ...
        <section className={classes.usernameSection}>
          ...
          {isOwner ? (
            <>
              ...
              <div onClick={handleOptionsMenuClick} className={classes.settingWrapper}>
...
function UnfollowDialog({onClose, user, onUnfollowUser}){
  ...
  return(
    ...
    >
      ...
      <Divider />
      <Button onClick={handleUnfollowUser} className={classes.unfolowButton}>Unfollow</Button>
      <Divider />
...
function NameBioSection({ user }) {
  ...
  return (
    <section className={classes.section}>
      ...
      <a href={user.websit} target="_blank" rel="noopener noreferrer">
